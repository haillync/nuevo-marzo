        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('form#change-email').validate({
                    ...
                    messages: {
                        new_email: {
                            required: '?php echo osc_esc_js(__("Email: this field is required", "next_revo")); ?>.',
                            email: '<?php echo osc_esc_js(__("Invalid email address", "next_revo")); ?>.'
                        }
                    },
    ...
    <body>
        ...
        <div class="content user_account">
            ...
            <div id="main" class="modify_profile">
                <h2><?php _e('Change your e-mail', 'next_revo'); ?></h2>
                <ul id="error_list"></ul>
                <form id="change-email" action="<?php echo osc_base_url(true); ?>" method="post">
                    ...
                    <fieldset>
                        <p>
                            <label for="email"><?php _e('Current e-mail', 'next_revo'); ?></label>
                            <span><?php echo osc_logged_user_email(); ?></span>
                        </p>
                        <p>
                            <label for="new_email"><?php _e('New e-mail', 'next_revo'); ?> *</label>
