 ...
 */
    ...
    */
    ...
    function osc_item_title($locale = "") {
		...
		function osc_item_canal($locale = "") {
        if ($locale == "") $locale = osc_current_user_locale();
        $canal = osc_item_field("s_canal", $locale);
        if($canal=='') {
            $canal = osc_item_field("s_canal", osc_language());
            if($canal=='') {
                $aLocales = osc_get_locales();
                foreach($aLocales as $locale) {
                    $canal = osc_item_field("s_canal", @$locale['pk_c_code']);
                    if($canal!='') {
                        break;
                    }
                }
