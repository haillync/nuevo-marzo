    ...
    Class ItemActions
    {
        ...
        public function add()
        {
            ...
            if ($flash_error) {
                ...
                $this->insertItemLocales('ADD', $aItem['title'], $aItem['description'], $aItem['canal'], $itemId );
        ...
        function edit() {
            ...
            if ($flash_error) {
                ...
                $this->insertItemLocales( 'EDIT', $aItem['title'], $aItem['description'], $aItem['canal'], $aItem['idItem'] );
        ...
        public function prepareData( $is_add )
        {
            ...
            $aItem['countryId']     = "ES";//Params::getParam('countryId');
			...
			$aItem['canal']  		= Params::getParam('canal');
        ...
        function insertItemLocales($type, $title, $description, $canal, $itemId )
        {
            foreach($title as $k => $_data){
                $_title         = $title[$k];
                $_description   = $description[$k];
				$_canal         = $canal[$k];
                if($type == 'ADD'){
                    $this->manager->insertLocale($itemId, $k, $_title, $_description, $_canal);
                }else if($type == 'EDIT'){
                    $this->manager->updateLocaleForce($itemId, $k, $_title, $_description, $_canal);
                }
            }
        }
