 ...
 */
    ...
    class ItemForm extends Form {
        ...
        static public function title_input($name, $locale = 'es_ES', $value = '')
        {
            parent::generic_input_text($name . '[' . $locale . ']', $value);
            return true;
        }

        static public function description_textarea($name, $locale = 'es_ES', $value = '')
        {
            parent::generic_textarea($name . '[' . $locale . ']', $value);
            return true;
        }
		
		static public function canal_text($name='canal', $locale = 'es_ES', $value = '')
        {
            parent::generic_input_text($name . '[' . $locale . ']', $value);
            return true;
        }
